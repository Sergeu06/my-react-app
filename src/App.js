...
function getPageBg(pathname) {
  if (pathname.includes("/fight")) return "rgba(11, 15, 22, 0.25)";
  ...
  if (pathname.includes("/raid")) return "rgba(55, 18, 14, 0.25)";
  if (pathname.includes("/open-box")) return "rgba(10, 33, 41, 0.25)";
  if (pathname.includes("/result")) return "rgba(28, 16, 38, 0.25)";
  return null;
}
